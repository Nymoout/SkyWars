...
public class SWRServer {
    ...
    public void saveSigns() {
        ...
        SkyWars.get().getConfig().set(this.getServerName(), signLocs);
    }
    ...
    private void setMaterial(Block attachedBlock) {
        if (state.equals(MatchState.OFFLINE)) {
            attachedBlock.setType(Material.valueOf(SkyWars.getCfg().getMaterial("blockoffline")));
        } else if (state.equals(MatchState.WAITINGSTART)) {
            attachedBlock.setType(Material.valueOf(SkyWars.getCfg().getMaterial("blockwaiting")));
        } else if (state.equals(MatchState.PLAYING) || state.equals(MatchState.SUDDENDEATH)) {
            attachedBlock.setType(Material.valueOf(SkyWars.getCfg().getMaterial("blockplaying")));
        } else if (state.equals(MatchState.ENDING)) {
            attachedBlock.setType(Material.valueOf(SkyWars.getCfg().getMaterial("blockending")));
        }
    }
