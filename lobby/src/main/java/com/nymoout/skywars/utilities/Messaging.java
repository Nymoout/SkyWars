...
public final class Messaging {
    ...
    public static class MessageFormatter {
        ...
        public String format(String message) {
            ...
            if (SkyWars.getMessaging().getMessage(message) != null) {
                message = SkyWars.getMessaging().getMessage(message);
            }
            ...
            if (prefix) {
                message = SkyWars.getMessaging().getPrefix() + message;
            }
	...
	private void copyDefaults(File playerFile) {
		...
		Reader defConfigStream = new InputStreamReader(SkyWars.get().getResource("messages.yml"));
