...
public class KillSoundSelectionMenu {
    ...
    public KillSoundSelectionMenu(final Player player) {
        List<SoundItem> availableItems = SkyWars.getLM().getKillSoundItems();
        ...
        SkyWars.getIC().create(player, menuName, rowCount, new IconMenu.OptionClickEventHandler() {
            ...
            public void onOptionClick(IconMenu.OptionClickEvent event) {
                ...
                SoundItem sound = SkyWars.getLM().getKillSoundByName(name);
                if (sound == null) {
                    return;
                }           
                ...
                if (SkyWars.getCfg().economyEnabled() && !player.hasPermission("sw.killsound." + sound.getKey())) {
