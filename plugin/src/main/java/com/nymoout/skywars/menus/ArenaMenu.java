...
public class ArenaMenu {
    ...
    public ArenaMenu(String key, GameMap gMap) {
        ...
        Runnable update = () -> {
            if (SkyWars.getIconMenuController().hasViewers(key)) {
                ...
                ItemStack min = SkyWars.getNMS().getItemStack(new ItemStack(Material.DIAMOND_HELMET, 1), lores, "Minimun Players");
                ...
                ItemStack status = SkyWars.getNMS().getItemStack(new ItemStack(Material.MAP, 1), lores, "Arena Status");
                ...
                ItemStack display = SkyWars.getNMS().getItemStack(new ItemStack(Material.NAME_TAG, 1), lores, "Display Name");
                ...
                ItemStack creator = SkyWars.getNMS().getItemStack(SkyWars.getNMS().getMaterial("SKULL_ITEM"), lores, "Map Creator");
                ...
                ItemStack signs = SkyWars.getNMS().getItemStack(new ItemStack(Material.SIGN, 1), lores, "Join Signs");
                ...
                ItemStack spectate = SkyWars.getNMS().getItemStack(new ItemStack(Material.COMPASS, 1), lores, "Spectate");

                lores.clear();
                lores.add(ChatColor.AQUA + "Shift Left Click to");
                lores.add(ChatColor.AQUA + "End Current Match!");
                ItemStack end = SkyWars.getNMS().getItemStack(new ItemStack(SkyWars.getNMS().getMaterial("ENDER_PORTAL_FRAME")), lores, "End Match");
                ...
                ItemStack edit = SkyWars.getNMS().getItemStack(new ItemStack(SkyWars.getNMS().getMaterial("WORKBENCH")), lores, "Edit Map");
                ...
                ItemStack save = SkyWars.getNMS().getItemStack(new ItemStack(Material.BOOK, 1), lores, "Save Map");
                ...
                ItemStack cage = SkyWars.getNMS().getItemStack(new ItemStack(SkyWars.getNMS().getMaterial("IRON_FENCE")), lores, "Cage Type");

                lores.clear();
                lores.add(ChatColor.AQUA + "Left Click to view events!");
                ItemStack events = SkyWars.getNMS().getItemStack(new ItemStack(Material.JUKEBOX, 1), lores, "Events");
                ...
                ItemStack teams = SkyWars.getNMS().getItemStack(new ItemStack(SkyWars.getNMS().getMaterial("REDSTONE_COMPARATOR")), lores, "Teams");
        ...
        SkyWars.getIconMenuController().getMenu(key).setUpdate(update);
    }
